        ...
        <div class="layar-dalam">
            ...
            <div class="menu">
                ...
                <ul id="navbar">
                    ...
                    @auth
                        <li>
                            <div class="user" style="color: black;font-weight:600;position: fixed;">
                                Hello,&nbsp;{{auth()->user()->name}}
                            </div>
                        </li>
                        <li>
                            <form action="logout" method="post" style="position: fixed;">
                                @csrf
        ...
        <main>
            ...
            <section id="arenakonser">
                <div class="layar-dalam">
                    <h3>GOR BADMINTON</h3>
                    <p class="ringkasan">
                        Lakukan olahragamu di Tempat yang Tepat
                    </p>
                    <section id="next">
                        <a href="/Konser">Arena Konser</a>
                        <a href="/Ballroom">Ballroom</a>
                        <a class="active" href="#popup">Olahraga</a>
